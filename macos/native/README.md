...
Xcode Command Line Tools. Seven public C symbols form ABI version 2; the added
callback-open entry lets the decoder worker wait for a growing FLAC file. The library
